...
export const themeViewerCss = `
  &[data-theme-pack='glass'] .gallery-lightbox {
    ...
    .lightbox-control-layer:not([data-ui])::after { ${crystalRimCss} }
    .lightbox-toolbar {
    ...
    > [data-ui].lightbox-control-layer {
      border-radius: 50%;
  ...
  &[data-theme-pack='glass'][data-theme-mode='light'] .gallery-lightbox {
    background: #e1e3e6;
    .lightbox-control-layer:not([data-ui]) { color: #202020; --liquid-fill: #ffffff20; }
  ...
  @media (prefers-reduced-transparency: reduce), (prefers-contrast: more), (forced-colors: active) {
    &[data-theme-pack='glass'] .gallery-lightbox .lightbox-control-layer:not([data-ui]) {
  ...
  &[data-theme-pack='polaroid'] .gallery-lightbox {
    ...
    > [data-ui='button'].lightbox-control-layer {
      border-radius: 50%;
    }
    .lightbox-filmstrip {
  ...
  @media (max-width: 600px) {
    ...
    &[data-theme-pack='glass'] .gallery-lightbox > [data-ui='button'].lightbox-control-layer { width: 44px; height: 44px; }
  }
`
