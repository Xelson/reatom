...
export const retroDetailsCss = `
  &[data-theme-pack='retroOs'] {
    ...
    &[data-theme-mode='dark'] {
      --folder-header-rail-height: 46px;
      --retro-face: #000080;
      --retro-paper: #000080;
      --retro-ink: #00ffff;
      --retro-muted: #a5dddd;
      ...
      --retro-title: linear-gradient(90deg, #0a4a9c, #2a8ad4);
      --retro-raised: none;
      --retro-inset: none;
    }
    ...
    #gallery-toolbar {
      position: relative;
      min-height: 92px;
      padding: 40px var(--header-inline-pad) 10px;
      gap: 10px;
      overflow: visible;
    ...
    --folder-header-rail-height: 42px;
    #gallery-pathbar {
      min-height: 42px;
      border: 1px solid var(--retro-edge);
      box-shadow: var(--retro-raised);
    ...
    @media (max-width: 600px) {
      ...
      #gallery-toolbar { padding: 38px var(--header-inline-pad) 8px; }
