...
| **Richest *dedicated* tagger** | RAM++ INT8, 4,585 everyday tags | **873 MB** | Community ONNX only. **No browser demo** |
...
| **Zero extra model in *our* bundle** | Chrome **Prompt API** (Gemini Nano) + JSON `{ tags: string[] }` | browser-managed | Shipped **Chrome 148+** desktop. Not in workers. Hardware-gated |
...
- Hardware: desktop Win/macOS 13+/Linux/Chromebook Plus; **≥22 GB** free; GPU **>4 GB VRAM** *or* 16 GB RAM + 4 cores
